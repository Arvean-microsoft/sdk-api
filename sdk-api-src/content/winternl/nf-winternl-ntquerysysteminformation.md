...
Adds a PMU (Performance Monitoring Unit) profile source. The buffer pointed to by the <i>SystemInformation</i> parameter should contain a <b>SYSTEM_PMU_SOURCE_ADD_INFORMATION</b> structure describing the profile source to add. This information class is used with <b>NtSetSystemInformation</b>. The caller must be a member of the Administrators group or the Performance Log Users group.



#### SystemPmuSourceRemoveInformation

Removes a PMU (Performance Monitoring Unit) profile source. The buffer pointed to by the <i>SystemInformation</i> parameter should contain a <b>SYSTEM_PMU_SOURCE_REMOVE_INFORMATION</b> structure identifying the profile source to remove. This information class is used with <b>NtSetSystemInformation</b>. The caller must be a member of the Administrators group or the Performance Log Users group.
